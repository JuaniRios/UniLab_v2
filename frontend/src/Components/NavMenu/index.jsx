...
export default function NavMenu(props) {
	...
	const [profileClasses, setProfileClasses] = useReducer(
		changeProfileClasses,
		initProfileClasses
	);
	...
	const [languageClasses, setLanguageClasses] = useReducer(
		changeLanguageClasses,
		initLanguageClasses
	);
	...
	function keyFuncNavMenu(event) {
		if (event.key === "Escape") {
			if (loginClasses[0] === "login-form-opened") {
				...
				loginClasses[0] === "login-form-closed" &&
				profileClasses[0] === "profile-menu-opened"
			) {
				setProfileClasses();
	...
	return (
		<>
			...
			/>
			<GeneralSearch searchClasses={searchClasses} setSearchClasses={setSearchClasses} />
			<SideProfileMenu
