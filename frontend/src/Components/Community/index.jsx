...
export default function Community(props) {
	...
	const [postFormClasses, setPostFormClasses] = useReducer(
		changePostFormClasses,
		initPostFormClasses
	);
	return (
		<>
			...
			<div className={`main-content`}>
				<PostForm
					postFormClasses={postFormClasses}
					setPostFormClasses={setPostFormClasses}
					setPosts={setPosts}
				/>
