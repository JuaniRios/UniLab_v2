	...
	async function seeApplications(userUrl, toggle) {
		...
		try {
			...
			for (const applicationUrl of applications) {
				const application = await apiCall(applicationUrl, token, {
					method: "GET",
					fullUrl: true,
				});
				newApplicationsList.push(<Application {...application} />);
			}
			setApplicationsList(
				<ApplicationsSlider
		...
		<>
			...
			<div className={`main-content`}>
				<div className={`profile-university`}>
					...
					>
						...
						<DoubleInputWrap>
							...
							<SelectorInput
								label={"Size"}
								required={false}
								value={uniStudentRange}
								setter={setUniStudentRange}
								choices={{
									"<5000 students": 1,
									"5000-15000 students": 2,
									">15000 students": 3,
								}}
							/>
						</DoubleInputWrap>
					...
					{/*SIDE BAR*/}
					<div className={`main-profile-menu-university`}>
						<div className={`fixed-menu-university`}>
							<NavLink
								to="#basic-info"
								className={`profile-menu-item-university ${menuClassesArray[0]}`}
							...
							<NavLink
								to="#students"
								className={`profile-menu-item-university ${menuClassesArray[1]}`}
							...
							{isAdmin && (
								<NavLink
									to="#admins"
									className={`profile-menu-item-university ${menuClassesArray[3]}`}
							...
							<NavLink
								to="#posts"
								className={`profile-menu-item-university ${menuClassesArray[4]}`}
							...
							<NavLink
								to="#comments"
								className={`profile-menu-item-university ${menuClassesArray[5]}`}
					...
					{/*MAIN CONTENT*/}
					<div className={`profile-content-container-university`}>
						<ProfileContentFrame
							id="basic-info"
							className={`${contentClassesArray[0]}`}
						>
							<div className={`profile-banner-university`}>
								<img
									className={`profile-banner-pfp-university`}
							...
							<div className={`profile-basic-info`}>
								{isAdmin && (
									<img
										className={`basic-info-toggler-university`}
										src={pencil_icon}
										alt="Pen icon"
